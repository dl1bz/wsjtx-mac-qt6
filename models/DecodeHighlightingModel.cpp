...
bool operator == (DecodeHighlightingModel::HighlightInfo const& lhs,
                  DecodeHighlightingModel::HighlightInfo const& rhs) {
...
QString DecodeHighlightingModel::highlight_name(Highlight h) {
  switch (h) {
  case Highlight::CQ:
    return tr("CQ in message");
  case Highlight::MyCall:
    return tr("My Call in message");
  case Highlight::Tx:
    return tr("Transmitted message");
  case Highlight::DXCC:
    return tr("New DXCC");
  case Highlight::DXCCBand:
    return tr("New DXCC on Band");
  case Highlight::Grid:
    return tr("New Grid");
  case Highlight::GridBand:
    return tr("New Grid on Band");
  case Highlight::Call:
    return tr("New Call");
  case Highlight::CallBand:
    return tr("New Call on Band");
  case Highlight::Continent:
    return tr("New Continent");
  case Highlight::ContinentBand:
    return tr("New Continent on Band");
  case Highlight::CQZone:
    return tr("New CQ Zone");
  case Highlight::CQZoneBand:
    return tr("New CQ Zone on Band");
  case Highlight::ITUZone:
    return tr("New ITU Zone");
  case Highlight::ITUZoneBand:
    return tr("New ITU Zone on Band");
  case Highlight::LotW:
    return tr("LoTW User");
  case Highlight::USState:
    return tr("New US State");
  case Highlight::USStateBand:
    return tr("New US State on Band");
  }
  return "Unknown";
}
