...
public:
  ...
  void checkSaneDates() {
    if (enable_dates_checkbox_->isChecked() && start_date_time_edit_->dateTime().isValid() &&
...
void Configuration::transceiver_modulator_start(QString jtmode, unsigned symbolslength, double framespersymbol,
    double trfrequency,
...
#endif
  m_->transceiver_modulator_start(jtmode, symbolslength, framespersymbol, trfrequency, tonespacing, synchronize, fastmode,
                                  dbsnr, trperiod);
}
...
void Configuration::sync_transceiver(bool force_signal, bool enforce_mode_and_split) {
  LOG_TRACE("force signal: " << force_signal << " enforce_mode_and_split: " << enforce_mode_and_split << ' ' <<
...
Configuration::impl::impl(Configuration * self, QNetworkAccessManager * network_manager
  ...
  connect(ui_->sound_input_combo_box, &LazyFillComboBox::about_to_show_popup, [this]() {
    ...
    update_audio_channels(ui_->sound_input_combo_box, ui_->sound_input_combo_box->currentIndex(),
                          ui_->sound_input_channel_combo_box, false);
  ...
  connect(ui_->sound_output_combo_box, &LazyFillComboBox::about_to_show_popup, [this]() {
    ...
    update_audio_channels(ui_->sound_output_combo_box, ui_->sound_output_combo_box->currentIndex(),
                          ui_->sound_output_channel_combo_box, true);
  ...
  connect(ui_->udp_interfaces_combo_box, &QComboBox::currentTextChanged, this,
          &Configuration::impl::validate_network_interfaces);
  ...
  QRegularExpression b32(QString("(^[") + QString(BASE32_CHARSET) + QString(BASE32_CHARSET).toLower() +
                         QString("]{16}$)|(^$)"));
  ...
  ui_->special_op_activity_button_group->setId(ui_->rbNA_VHF_Contest,
      static_cast<int> (SpecialOperatingActivity::NA_VHF));
  ui_->special_op_activity_button_group->setId(ui_->rbEU_VHF_Contest,
      static_cast<int> (SpecialOperatingActivity::EU_VHF));
  ...
  ui_->PTT_port_combo_box->setItemData(ui_->PTT_port_combo_box->count() - 1, "Delegate to proxy CAT service",
                                       Qt::ToolTipRole);
  //
  ...
  //
  {
    ...
    function<void (int)> cb(bind(&Configuration::impl::update_audio_channels, this, ui_->sound_input_combo_box, _1,
                                 ui_->sound_input_channel_combo_box, false));
    connect(ui_->sound_input_combo_box, static_cast<void (QComboBox::*)(int)> (&QComboBox::currentIndexChanged), cb);
    cb = bind(&Configuration::impl::update_audio_channels, this, ui_->sound_output_combo_box, _1,
              ui_->sound_output_channel_combo_box, true);
...
void Configuration::impl::read_settings() {
  ...
  type_2_msg_gen_ = settings_->value("Type2MsgGen",
                                     QVariant::fromValue(Configuration::type_2_msg_3_full)).value<Configuration::Type2MsgGen> ();
  ...
  if (!load_decode_highlighting_v2(settings_, highlight_items)) {
    highlight_items = settings_->value("DecodeHighlighting",
                                       QVariant::fromValue(DecodeHighlightingModel::default_items())).value<DecodeHighlightingModel::HighlightItems> ();
  }
  ...
  rig_params_.data_bits = settings_->value("CATDataBits",
                          QVariant::fromValue(TransceiverFactory::default_data_bits)).value<TransceiverFactory::DataBits> ();
  rig_params_.stop_bits = settings_->value("CATStopBits",
                          QVariant::fromValue(TransceiverFactory::default_stop_bits)).value<TransceiverFactory::StopBits> ();
  rig_params_.handshake = settings_->value("CATHandshake",
                          QVariant::fromValue(TransceiverFactory::handshake_default)).value<TransceiverFactory::Handshake> ();
  ...
  rig_params_.ptt_type = settings_->value("PTTMethod",
                                          QVariant::fromValue(TransceiverFactory::PTT_method_VOX)).value<TransceiverFactory::PTTMethod> ();
  rig_params_.audio_source = settings_->value("TXAudioSource",
                             QVariant::fromValue(TransceiverFactory::TX_audio_source_front)).value<TransceiverFactory::TXAudioSource> ();
  ...
  rig_params_.split_mode = settings_->value("SplitMode",
                           QVariant::fromValue(TransceiverFactory::split_mode_none)).value<TransceiverFactory::SplitMode> ();
...
void Configuration::impl::set_rig_invariants() {
  ...
  auto is_hw_handshake = ui_->CAT_handshake_group_box->isEnabled()
                         && TransceiverFactory::handshake_hardware == static_cast<TransceiverFactory::Handshake>
  ...
  if (TransceiverFactory::basic_transceiver_name_ == rig) {
    ...
    if (!ui_->rig_combo_box->currentText().startsWith("OmniRig") &&
        !ui_->rig_combo_box->currentText().startsWith("DX Lab") &&
        !ui_->rig_combo_box->currentText().startsWith("Ham Radio") &&
        !ui_->rig_combo_box->currentText().startsWith("Kenwood TS-480") &&
...
bool Configuration::impl::validate() {
  ...
  if ((TransceiverFactory::PTT_method_DTR == ptt_method || TransceiverFactory::PTT_method_RTS == ptt_method)
      && (ptt_port.isEmpty()
          || combo_box_item_disabled == ui_->PTT_port_combo_box->itemData(ui_->PTT_port_combo_box->findText(ptt_port),
              Qt::UserRole - 1))) {
...
void Configuration::impl::accept() {
  ...
  if (next_audio_input_channel_ != static_cast<AudioDevice::Channel>
  ...
  if (next_audio_output_channel_ != static_cast<AudioDevice::Channel>
...
void Configuration::impl::on_CTY_download_button_clicked(bool /*clicked*/) {
  ...
  connect(&cty_download, &FileDownload::error, this, &Configuration::impl::error_during_CTY_download,
          Qt::UniqueConnection);
...
void Configuration::impl::on_callsign_states_download_button_clicked(bool /*clicked*/) {
  ...
  connect(&cty_download, &FileDownload::complete, this, &Configuration::impl::after_callsign_states_downloaded,
          Qt::UniqueConnection);
  connect(&cty_download, &FileDownload::error, this, &Configuration::impl::error_during_callsign_states_download,
          Qt::UniqueConnection);
  cty_download.start_download();
...
void Configuration::impl::on_CALL3_download_button_clicked(bool /*clicked*/) {
  ...
  connect(&cty_download, &FileDownload::complete, this, &Configuration::impl::after_CALL3_downloaded,
          Qt::UniqueConnection);
  connect(&cty_download, &FileDownload::error, this, &Configuration::impl::error_during_CALL3_download,
          Qt::UniqueConnection);
  cty_download.start_download();
...
void Configuration::impl::on_hamlib_download_button_clicked(bool /*clicked*/) {
  ...
  connect(&cty_download, &FileDownload::complete, this, &Configuration::impl::after_hamlib_downloaded,
          Qt::UniqueConnection);
  connect(&cty_download, &FileDownload::error, this, &Configuration::impl::error_during_hamlib_download,
          Qt::UniqueConnection);
...
void Configuration::impl::after_hamlib_downloaded() {
  ...
  QString hamlib = QString(QLatin1String(hamlib_version2));
  if (hamlib.contains("Hamlib 5")) { hamlib_dll_basename = "libhamlib-5"; }
  QFile::rename(dataPath.absolutePath() + "/" + hamlib_dll_basename + ".dll",
                dataPath.absolutePath() + "/" + hamlib_dll_basename + "_old.dll");
...
void Configuration::impl::on_revert_update_button_clicked(bool /*clicked*/) {
  ...
  if (f.exists()) {
    ...
    ui_->hamlib_download_button->setEnabled(false);
    QFile::rename(dataPath.absolutePath() + "/" + hamlib_dll_basename + ".dll",
                  dataPath.absolutePath() + "/" + hamlib_dll_basename + "_new.dll");
    QTimer::singleShot(1000, [ = ] {
...
void Configuration::impl::on_udp_server_line_edit_editingFinished() {
  if (this->isVisible()) {
    ...
    switch (n) {
    case 0:
      iperr = "Error before first number";
      break;
    case 1:
      iperr = "Error between first and second number";
      break;
    case 2:
      iperr = "Error between second and third number";
      break;
    case 3:
      iperr = "Error between third and fourth number";
      break;
    case 4:
      iperr = "";
      break;
    case 5:
      iperr = "Invalid characters after IP address";
      break;
    default:
      iperr = "Unknown error parsing network address";
    }
    if (n != 4) {
...
void Configuration::impl::load_frequencies() {
  auto file_name = QFileDialog::getOpenFileName(this, tr("Load Working Frequencies"), writeable_data_dir_.absolutePath(),
                   tr("Frequency files (*.qrg *.qrg.json);;All files (*.*)"));
  if (!file_name.isNull()) {
...
void Configuration::impl::merge_frequencies() {
  auto file_name = QFileDialog::getOpenFileName(this, tr("Merge Working Frequencies"), writeable_data_dir_.absolutePath(),
                   tr("Frequency files (*.qrg *.qrg.json);;All files (*.*)"));
  if (!file_name.isNull()) {
...
void Configuration::impl::save_frequencies() {
  auto file_name = QFileDialog::getSaveFileName(this, tr("Save Working Frequencies"), writeable_data_dir_.absolutePath(),
                   tr("Frequency files (*.qrg *.qrg.json);;All files (*.*)"));
  if (!file_name.isNull()) {
...
bool Configuration::impl::open_rig(bool force) {
  ...
  if (force || !rig_active_ || rig_data != saved_rig_params_) {
    try {
      ...
      rig_connections_ << connect(rig.get(), &Transceiver::tciframeswritten, this,
                                  &Configuration::impl::handle_transceiver_tciframeswritten);
      rig_connections_ << connect(rig.get(), &Transceiver::tci_mod_active, this,
                                  &Configuration::impl::handle_transceiver_tci_mod_active);
...
void Configuration::impl::transceiver_modulator_start(QString jtmode, unsigned symbolslength, double framespersymbol,
...
QAudioDevice Configuration::impl::find_audio_device(QAudioDevice::Mode mode, QComboBox * combo_box
  ...
  if (device_name.size()) {
    ...
    if (!tci_audio_) combo_box->insertItem(0, device_name + " (" + tr("Not found", "audio device missing") + ")",
                                             QVariant::fromValue(audio_info_type {}));
    else {
...
void Configuration::impl::load_audio_devices(QAudioDevice::Mode mode, QComboBox* combo_box, QAudioDevice* device) {
  ...
  if (sortAlphabetically_) {
    ...
    for (const auto& p : filtered_devices) {
      qDebug() << "Configuration::impl::load_audio_devices: input:" << "name:" << p.description() << "preferred format:" <<
               p.preferredFormat();
...
void Configuration::impl::update_audio_channels(QComboBox const * source_combo_box, int index, QComboBox * combo_box,
    bool allow_both) {
  // disable all items
