...
MessageAggregatorMainWindow::MessageAggregatorMainWindow()
  ...
  Q_ASSERT(row >= 0);
  network_interfaces_form_label_widget_ = static_cast<QLabel *> (group_box_layout->itemAt(row,
  ...
  connect(network_interfaces_combo_box_, &QComboBox::currentTextChanged, this,
          &MessageAggregatorMainWindow::validate_network_interfaces);
