...
LogQSO::LogQSO(QString const& programTitle, QSettings * settings
  ...
  sat_file_location = dataPath.exists(sat_file_name) ? dataPath.absoluteFilePath(sat_file_name) :
                      m_config->data_dir().absoluteFilePath(sat_file_name);
...
void LogQSO::loadSettings() {
  ...
  QDir dataPath {QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation)};
  comments_location = dataPath.exists("comments.txt") ? dataPath.absoluteFilePath("comments.txt") :
                      m_config->data_dir().absoluteFilePath("comments.txt");
