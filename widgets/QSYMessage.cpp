...
QSYMessage::QSYMessage(const QString& message, const QString& theCall, QSettings * settings,
                       Configuration const * configuration, QWidget *parent) :
  QWidget {parent},
  settings_ {settings},
...
void QSYMessage::getBandModeFreq() {
  ...
  } else if (receivedMessage.at(0).isLetter() || receivedMessage.at(0) == '9' || receivedMessage.at(0) == '4' ||
             receivedMessage.at(0) == '7') {
    QString bandParam = "";
